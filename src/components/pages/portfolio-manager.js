...
export default class PortfolioManager extends Component {
    ...
    handleSuccessfulFormSubmission(portfolioItem) {
        console.log('handleFormSuccessfulSubmission', portfolioItem);
        this.setState({
    ...
    getPortfolioItems() {
        axios.get('https://johnattan.devcamp.space/portfolio/portfolio_items?order_by=created_at&direction=desc' ,
        {withCredentials: true}
        ).then(response => {
            this.setState({
