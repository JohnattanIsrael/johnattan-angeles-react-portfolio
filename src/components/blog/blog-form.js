...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: '',
            featured_image: '',
            apiUrl: 'https://johnattan.devcamp.space/portfolio/portfolio_blogs',
            apiAction: 'post'
        };
    ...
    deleteImage(imageType) {
        ...
        {withCredentials: true}
            ...
            console.log('deleteImage errro',  error);    
        })
    ...
    componentWillMount() {
        if (this.props.editMode) {
            this.setState({
                ...
                apiUrl: `https://johnattan.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
                apiAction:'patch'
            })
        }
    }
            ...
            <form onSubmit={this.handleSubmit} className='blog-form-wrapper'>
                ...
                <div className='one-column'>
                    <RichTextEditor
                        ...
                        contentToEdit={this.props.editMode &&
